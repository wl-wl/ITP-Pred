...
def do_model():
    for fold in range(num_cross_val):
        ...
        # model.add(Dense(32, kernel_initializer='he_normal', activation='relu', W_regularizer=l2(0.01)))
...
open('model2_arthitecture_2.yaml', 'w').write(yaml_string)
