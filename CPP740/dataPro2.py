...
def CTD():
    protein_seq_dict1 = {}
    protein_index1 = 1
    with open('C:\\Users\\86151\\Desktop\\CPP\\CTD.txt', 'r') as t:
        for line in t:
            seq = line[:-1].split('\t')[1:]
...
def fe():  #aac
    protein_seq_dict1 = {}
    protein_index1 = 1
    with open('C:\\Users\\86151\\Desktop\\CPP\\AAC.txt', 'r') as t:
        for line in t:
            seq = line[:-1].split('\t')[1:]
            protein_seq_dict1[protein_index1] = seq
            protein_index1= protein_index1 + 1
...
def ac():
    ...
    protein_seq_dict = {}
    protein_index = 1
    with open('C:\\Users\\86151\\Desktop\\CPP\\AC.txt', 'r') as fp:
        for line in fp:
            if line[0] == '>':
...
def gaac():#gaac
    protein_seq_dict1 = {}
    protein_index1 = 1
    with open('C:\\Users\\86151\\Desktop\\CPP\\GAAC.txt', 'r') as t:
        for line in t:
            seq = line[:-1].split('\t')[1:]
            protein_seq_dict1[protein_index1] = seq
            protein_index1= protein_index1 + 1
