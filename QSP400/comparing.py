...
for fold in range(num_cross_val):
    ...
    model = Sequential()
    model.add(LSTM(32, return_sequences=True, input_shape=(37, 1)))  # 82.5
...
# x_train, x_test, y_train, y_test = train_test_split(X, label, test_size=0.2, random_state=10)
# rfc = RandomForestClassifier(n_estimators=29)#0.8986486486486487 0.8860759493670886 0.9210526315789473 0.875 0.7975845555858628
# rfc = rfc.fit(x_train, y_train)
# # rfc.score(x_test,y_test)
# lstm_proba = rfc.predict(x_test)
